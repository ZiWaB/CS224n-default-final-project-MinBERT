...
class BertSentimentClassifier(torch.nn.Module):
    ...
    def __init__(self, config):
        ...
        self.cls_dropout = torch.nn.Dropout(config.hidden_dropout_prob)
    ...
    def forward(self, input_ids, attention_mask):
        ...
        pooler_output_dropout = self.cls_dropout(outputs['pooler_output']) # shape: (batch_size, hidden_states)
        logits = self.classifier(pooler_output_dropout) 
